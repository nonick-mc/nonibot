      ...
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <FieldGroup>
          <ControlledField control={form.control} name='enabled' orientation='horizontal'>
            <FieldContent>
              <ControlledFieldLabel>キックログを有効にする</ControlledFieldLabel>
              <FieldDescription>メンバーがキックされた際にログを送信します。</FieldDescription>
              <ControlledFieldError />
            </FieldContent>
            <ControlledSwitch />
          </ControlledField>
              ...
              <>
                ...
                >
                  <FieldContent>
                    ...
                    <FieldDescription>
                      選択したロールを持つメンバーが行うキックのログは送信されません。最大10個まで選択できます。
                    </FieldDescription>
                    <ControlledFieldError />
                  </FieldContent>
