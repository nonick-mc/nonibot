      ...
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <FieldGroup>
          <ControlledField control={form.control} name='enabled' orientation='horizontal'>
            <FieldContent>
              <ControlledFieldLabel>メッセージ削除ログを有効にする</ControlledFieldLabel>
              <FieldDescription>メッセージが削除された際にログを送信します。</FieldDescription>
              <ControlledFieldError />
            </FieldContent>
            <ControlledSwitch />
          </ControlledField>
              ...
              <>
                ...
                >
                  <FieldContent>
                    ...
                    <FieldDescription>
                      選択したロールを持つメンバーが行うメッセージ削除のログは送信されません。最大10個まで選択できます。
                    </FieldDescription>
                    <ControlledFieldError />
                  </FieldContent>
